...
\item \textbf{Readable:} Software that you can come back to 3 months later without having to allocate a whole research day to understand what it does and how it works.
  Software that other researchers in your community can understand and, constructively criticise...
and use!
...
Write software which functionalities can be re-used in other software: that saves time and reduces errors!
\end{itemize}
